  ...
  describe "#download_rank_string_calc" do
    it "returns number of downloads out total downloads" do
      ...
      create :gem_spec,
        total_downloads: 400,
        laser_gem: laser_gem
      expect(Ranking.new(laser_gem).download_rank_string_calc).to eq "2nd most downloaded gem of 4"
    end
    ...
    it "saves download_rank_string to database" do
      ...
      laser_gem.reload
      expect(laser_gem.download_rank_string).to eq "2nd most downloaded gem of 4"
    end
  end
